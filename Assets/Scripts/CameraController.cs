...
public class CameraController : MonoBehaviour
{
    ...
    //rotate camera according to mouse arrow movement in both axis
	public void Update()
	{
    ...
    //keep the camera the specified distance away from the player
    //we are using a raycast to detect camera collision with walls, so camera doesn't phase through the walls
